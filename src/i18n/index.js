    ...
    translation: {
      ...
      sections: {
        quemSomos: {
          ...
          paragrafo1: 'Eva chegou a Praia da Pipa há mais de 40 anos e nunca mais foi embora. O que começou como um encontro com esse litoral se transformou em uma carreira: 35 anos como corretora de imóveis, construindo uma rede de confiança que hoje se estende por todo o litoral norte do Rio Grande do Norte e João Pessoa.',
    ...
    translation: {
      ...
      sections: {
        quemSomos: {
          ...
          paragrafo1: 'Eva arrived in Praia da Pipa more than 40 years ago and never left. What began as an encounter with this coastline became a career: 35 years as a real estate agent, building a network of trust that today spans the northern coast of Rio Grande do Norte and João Pessoa.',
    ...
    translation: {
      ...
      sections: {
        quemSomos: {
          ...
          paragrafo1: 'Eva llegó a Praia da Pipa hace más de 40 años y nunca más se fue. Lo que comenzó como un encuentro con este litoral se transformó en una carrera: 35 años como corredora de propiedades, construyendo una red de confianza que hoy se extiende por todo el litoral norte de Rio Grande do Norte y João Pessoa.',
    ...
    translation: {
      ...
      sections: {
        quemSomos: {
          ...
          paragrafo1: 'Eva è arrivata a Praia da Pipa più di 40 anni fa e non se n\u2019è mai andata. Ciò che è iniziato come un incontro con questa costa è diventato una carriera: 35 anni come agente immobiliare, costruendo una rete di fiducia che oggi si estende lungo tutta la costa nord del Rio Grande do Norte e João Pessoa.',
    ...
    translation: {
      ...
      sections: {
        quemSomos: {
          ...
          paragrafo1: 'Eva est arrivée à Praia da Pipa il y a plus de 40 ans et n\u2019est jamais repartie. Ce qui a commencé comme une rencontre avec ce littoral est devenu une carrière : 35 ans comme agente immobilière, bâtissant un réseau de confiance qui s\u2019étend aujourd\u2019hui sur toute la côte nord de Rio Grande do Norte et João Pessoa.',
